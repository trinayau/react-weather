...
const Background = ({city}) => {
    ...
    <div className='unsplash-description'>
        <p>{photoLocation}</p>
        <p><a href={photoUrl ? photoUrl : 'https://unsplash.com/photos/u4uGoUBxmCE'} target="_blank" rel='noreferrer'>Photo</a> / <a href={photographerUrl ? photographerUrl : 'https://unsplash.com/@wildlittlethingsphoto'}>{photographer ? photographer : 'Helena Lopes'}</a> / <a href='https://unsplash.com/'>Unsplash</a></p>
    </div>
    </> );
}
